...
txt_path = os.path.join(path, "test")

feat = open(os.path.join(path, "features.txt"), 'r', encoding='utf-8')
sub = open(os.path.join(txt_path, "subject_test.txt"), "r")
activity = open(os.path.join(txt_path, "y_test.txt"), "r")

fin = open(os.path.join(path, "test.csv"), 'w')
...
lines1 = []
with open(os.path.join(txt_path, "X_test.txt"), 'r', encoding='utf-8') as f1:
    for line in f1:
